...
const reportsNewController = require("../controllers/reportsNew.controller");
...
// Jadval statistikasi (admin emas, foydalanuvchilar uchun ham)
router.get("/table-stats/:reportType/:tableName/:year", reportsNewController.getTableStats);

// Admin faqat route'lar
